...
export const HeroHighlight = ({
  ...
  return (
    <div
      className={cn(
        "group relative flex h-[30rem] w-full items-center justify-center bg-white md:h-[40rem] dark:bg-black",
        containerClassName,
      )}
...
export const Highlight = ({
  ...
  return (
    <motion.span
      ...
      className={cn(
        `relative inline-block rounded-2xl bg-gradient-to-r from-indigo-300 to-purple-300 px-1 pb-1 leading-snug md:leading-normal dark:from-indigo-500 dark:to-purple-500`,
        className,
      )}
    >
      {children}
